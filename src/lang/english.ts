export const translations = {
    ...
    customiser: {
        ...
        style: {
            ...
            content: {
                ...
                bgachicon: "Use Achievement Icon",
    ...
    tooltips: {
        ...
        bgachicon: "Use the icon of the unlocked achievement as the notification background",
        ...
        glowcolorbronze: "The glow color displayed when the unlock percentage is > $semirarity",
        glowcolorsilver: "The glow color displayed when the unlock percentage is < $semirarity and > $rarity",
        ...
        webhooksemi: `Toggle whether to post achievement information to a Discord server when a $semi achievement is unlocked`,
        webhookrare: "Toggle whether to post achievement information to a Discord server when a $rare achievement is unlocked",
        webhookplat: "Toggle whether to post achievement information to a Discord server when a $plat achievement is unlocked",
        ...
        webhookappid: "Show the AppID of the current game in the footer of the webhook embed",
        ...
        percentbadgeimgbronze: "The badge icon displayed when the unlock percentage is > $semirarity",
        sspercentbadgeimgbronze: "The badge icon displayed when the unlock percentage is > $semirarity",
        percentbadgeimgsilver: "The badge icon displayed when the unlock percentage is < $semirarity and > $rarity",
        sspercentbadgeimgsilver: "The badge icon displayed when the unlock percentage is < $semirarity and > $rarity",
        ...
        percentbadgeimgplat: "The badge icon displayed when all achievements have been unlocked",
        sspercentbadgeimgplat: "The badge icon displayed when all achievements have been unlocked",
        ...
        iconborderimgbronze: "The icon border image displayed when the unlock percentage > $semirarity",
        iconborderimgsilver: "The icon border image displayed when the unlock percentage is < $semirarity and > $rarity",
        ...
        decorationscale: "Increase or decrease the size of the Decoration element within the notification",
        ...
        webhookembedcolorsemi: "Set the color used in the webhook embed when a $semi achievement is unlocked",
        webhookembedcolorrare: "Set the color used in the webhook embed when a $rare achievement is unlocked",
        webhookembedcolorplat: "Set the color used in the webhook embed when a $plat achievement is unlocked",
    ...
    notificationelems: {
        ...
        content: {
            ...
            percentbadgeimgbronze: "Rarity: > $semirarity",
            sspercentbadgeimgbronze: "Rarity: > $semirarity",
            percentbadgeimgsilver: "Rarity: < $semirarity & > $rarity",
            sspercentbadgeimgsilver: "Rarity: < $semirarity & > $rarity",
...
export const missingdepssub = (opt: string,dep: string) => [
    `Looks like you're trying to enable the <span class="hl">${opt}</span> option, but this option cannot be enabled without installing the <code class="dialogcode">${dep}</code> package first`,
    `Please run <code class="dialogcode" style="user-select: text;">sudo apt-get install ${dep}</code> in order to install this dependency`
]