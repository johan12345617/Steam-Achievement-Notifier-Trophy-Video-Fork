export const translations = {
    ...
    customiser: {
        ...
        style: {
            ...
            content: {
                ...
                bgachicon: "Başarı Simgesini Kullan",
    ...
    tooltips: {
        ...
        bgachicon: "Kilitlenen başarı simgesini bildirim arka planı olarak kullan",
        ...
        glowcolorbronze: "Kilitleme yüzdesi > $semirarity olduğunda gösterilen parıltı rengi",
        glowcolorsilver: "Kilitleme yüzdesi < $semirarity ve > $rarity olduğunda gösterilen parıltı rengi",
        ...
        webhookmain: `$main başarısı kilitlendiğinde Discord sunucusuna başarı bilgisi gönderilip gönderilmeyeceğini değiştir`,
        webhooksemi: `$semi başarısı kilitlendiğinde Discord sunucusuna başarı bilgisi gönderilip gönderilmeyeceğini değiştir`,
        webhookrare: `$rare başarısı kilitlendiğinde Discord sunucusuna başarı bilgisi gönderilip gönderilmeyeceğini değiştir`,
        webhookplat: `$plat başarısı kilitlendiğinde Discord sunucusuna başarı bilgisi gönderilip gönderilmeyeceğini değiştir`,
        ...
        webhookappid: "Mevcut oyunun AppID'sini webhook embed'inin altbilgisinde göster",
        ...
        percentbadgeimgbronze: "Kilitleme yüzdesi > $semirarity olduğunda gösterilen rozet simgesi",
        sspercentbadgeimgbronze: "Kilitleme yüzdesi > $semirarity olduğunda gösterilen rozet simgesi",
        percentbadgeimgsilver: "Kilitleme yüzdesi < $semirarity ve > $rarity olduğunda gösterilen rozet simgesi",
        sspercentbadgeimgsilver: "Kilitleme yüzdesi < $semirarity ve > $rarity olduğunda gösterilen rozet simgesi",
        ...
        percentbadgeimgplat: "Tüm başarılar kilitlendiğinde gösterilen rozet simgesi",
        sspercentbadgeimgplat: "Tüm başarılar kilitlendiğinde gösterilen rozet simgesi",
        ...
        iconborderimgbronze: "Kilitleme yüzdesi > $semirarity olduğunda gösterilen simge çerçeve resmi",
        iconborderimgsilver: "Kilitleme yüzdesi < $semirarity ve > $rarity olduğunda gösterilen simge çerçeve resmi",
        ...
        webhookembedcolormain: `$main başarısı kilitlendiğinde webhook gömme içinde kullanılan rengi ayarla`,
        webhookembedcolorsemi: `$semi başarısı kilitlendiğinde webhook gömme içinde kullanılan rengi ayarla`,
    ...
    notificationelems: {
        ...
        content: {
            ...
            percentbadgeimgbronze: "Nadirlik: > $semirarity",
            sspercentbadgeimgbronze: "Nadirlik: > $semirarity",
            percentbadgeimgsilver: "Nadirlik: < $semirarity & > $rarity",
            sspercentbadgeimgsilver: "Nadirlik: < $semirarity & > $rarity",
