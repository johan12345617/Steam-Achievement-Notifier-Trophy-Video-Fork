export const translations = {
    global: {
        ...
        show: "Mostra",
        exit: "Esci",
        donotshowagain: "Non mostrare più questa finestra di dialogo",
        ...
        raenablelogsub: [
            ...
            `<details>
                ...
                <div>
                    <span class="hl">PPSSPP > Impostazioni > Strumenti per sviluppatori > Generale > Registra su file</span> deve essere abilitato e configurato con le seguenti impostazioni:
                    <br>
                    <ul>
                        <li><span class="hllb">Obiettivi</span>: <span class="hlgreen">Informazioni</span></li>
                    </ul>
                    <br>
                    Con le impostazioni di installazione predefinite, il file <span class="hl">"log.txt"</span> è memorizzato in:
                    <br>
                    <ul>
    ...
    settings: {
        ...
        notifications: {
            ...
            content: {
                ...
                notifymax: "Notifiche massime", 
                notifyspace: "Spaziatura notifiche",
                notify1line: "Limita il testo a 1 riga"
            }
        },
        games: {
            title: "Giochi",
        ...
        ra: {
            ...
            content: {
                ...
                status: "Stato",
                game: "Gioco",
                lastachievement: "ID ultimo obiettivo",
    ...
    customiser: {
        ...
        style: {
            ...
            content: {
                ...
                bgachicon: "Usa Icona di Successo",
        ...
        theme: {
            ...
            content: {
                ...
                copytheme: "Copia tema",
                copythemesub: "Seleziona il/i tipo/i di notifica a cui copiare il tema selezionato"
            }
        }
    },
    logwin: {
    ...
    tooltips: {
        ...
        bgachicon: "Usa l'icona del successo sbloccato come sfondo della notifica",
        ...
        glowcolorbronze: "Il colore della luce visualizzato quando la percentuale di sblocco è > $semirarity",
        glowcolorsilver: "Il colore della luce visualizzato quando la percentuale di sblocco è < $semirarity e > $rarity",
        ...
        webhookmain: `Attiva o disattiva l’invio delle informazioni sul traguardo a un server Discord quando viene sbloccato un traguardo $main`,
        webhooksemi: `Attiva o disattiva l’invio delle informazioni sul traguardo a un server Discord quando viene sbloccato un traguardo $semi`,
        webhookrare: "Attiva o disattiva l’invio delle informazioni sul traguardo a un server Discord quando viene sbloccato un traguardo $rare",
        webhookplat: "Attiva o disattiva l’invio delle informazioni sul traguardo a un server Discord quando viene sbloccato un traguardo $plat",
        ...
        webhookappid: "Mostra l'AppID del gioco attuale nel piè di pagina dell'embed del webhook",
        ...
        percentbadgeimgbronze: "L’icona del distintivo visualizzata quando la percentuale di sblocco è > $semirarity",
        sspercentbadgeimgbronze: "L’icona del distintivo visualizzata quando la percentuale di sblocco è > $semirarity",
        percentbadgeimgsilver: "L’icona del distintivo visualizzata quando la percentuale di sblocco è < $semirarity e > $rarity",
        sspercentbadgeimgsilver: "L’icona del distintivo visualizzata quando la percentuale di sblocco è < $semirarity e > $rarity",
        ...
        percentbadgeimgplat: "L’icona del distintivo visualizzata quando tutti i traguardi sono stati sbloccati",
        sspercentbadgeimgplat: "L’icona del distintivo visualizzata quando tutti i traguardi sono stati sbloccati",
        ...
        iconborderimgbronze: "L’immagine del bordo dell’icona visualizzata quando la percentuale di sblocco è > $semirarity",
        iconborderimgsilver: "L’immagine del bordo dell’icona visualizzata quando la percentuale di sblocco è < $semirarity e > $rarity",
        ...
        webhookembedcolormain: "Imposta il colore usato nell’embed del webhook quando viene sbloccato un traguardo $main",
        webhookembedcolorsemi: "Imposta il colore usato nell’embed del webhook quando viene sbloccato un traguardo $semi",
        ...
        ppsspppath: `Imposta il percorso del file di registro <span class="hl">"log.txt"</span> di PPSSPP<br><br><span class="ttdesc">Con le impostazioni di installazione predefinite, il file <span class="hl">"log.txt"</span> è memorizzato in <span class="hllb">%PROGRAMFILES%\\PPSSPP\\PSP\\memstick\\PSP\\SYSTEM\\DUMP</span></span>`,
        ...
        lognum: `Il numero di file di registro precedenti conservati prima della cancellazione. Un nuovo file di registro verrà generato a ogni avvio dell'app<br><br><span class="ttdesc">Quando impostato su 0, tutti i file di registro precedenti verranno eliminati alla chiusura</span>`, 
        detectedappid: `Usa l'<span class="hl">AppID</span> del gioco attualmente rilevato`,
        listmode: `Imposta il comportamento della <span class="hl">Lista di esclusione</span>/<span class="hl">Lista di inclusione</span><br><br><span class="ttdesc">• <span class="hl">Esclusione</span>: Ignora solo i giochi specificati nell'elenco<br>• <span class="hl">Inclusione</span>: Ignora tutti i giochi tranne quelli specificati nell'elenco</span>`,
        notifymax: `Imposta il numero massimo di notifiche simultanee sullo schermo<br><br><span class="ttdesc">Aumentare il numero di notifiche simultanee richiede più risorse e può ridurre le prestazioni</span>`,
        notifyspace: "Imposta la distanza tra le notifiche simultanee sullo schermo",
        audiocooldown: `Imposta il tempo di attesa prima che le notifiche successive possano riprodurre un nuovo suono<br><br><span class="ttdesc">L'audio non sarà influenzato se Notifiche massime è impostato su 1</span>`,
    ...
    inclusions: {
        content: {
            managesub: [
                `Aggiungi l'<span class="hl">AppID</span> di qualsiasi gioco Steam alla <span class="hl">Lista di inclusione</span>`,
                `Steam Achievement Notifier tenterà di tracciare i dati degli obiettivi solo per i giochi il cui <span class="hl">AppID</span> è stato aggiunto alla <span class="hl">Lista di inclusione</span>`,
                `<span class="hl help" id="appidhelp"><u>Come posso trovare l'AppID di un gioco Steam?</u></span>`
            ],
            inclusionnew: "Nuova inclusione",
            inclusionnewsub: [
                `Inserisci l'<span class="hl">AppID</span> da aggiungere alla <span class="hl">Lista di inclusione</span>`
            ],
            inclusionedit: "Modifica inclusione",
            inclusioneditsub: [
                `Modifica l'<span class="hl">AppID</span> esistente nella <span class="hl">Lista di inclusione</span>`
            ]
        }
    },
    notificationelems: {
        ...
        content: {
            ...
            percentbadgeimgbronze: "Rarità: > $semirarity",
            sspercentbadgeimgbronze: "Rarità: > $semirarity",
            percentbadgeimgsilver: "Rarità: < $semirarity & > $rarity",
            sspercentbadgeimgsilver: "Rarità: < $semirarity & > $rarity",
...
export const missingdepssub = (opt: string,dep: string) => [
    `Sembra che tu stia cercando di abilitare l’opzione <span class="hl">${opt}</span>, ma questa opzione non può essere abilitata senza prima installare il pacchetto <code class="dialogcode">${dep}</code>`,
    `Esegui <code class="dialogcode" style="user-select: text;">sudo apt-get install ${dep}</code> per installare questa dipendenza`
]