export const translations = {
    ...
    tooltips: {
        ...
        glowcolorbronze: "当解锁百分比 > $semirarity 时显示的光晕颜色",
        glowcolorsilver: "当解锁百分比 < $semirarity 且 > $rarity 时显示的光晕颜色",
        ...
        fontshadowx: "水平移动文本阴影的位置",
        fontshadowy: "垂直移动文本阴影的位置",
        ...
        inclusionlist: `阻止应用程序跟踪所有 Steam 游戏，除非已指定<br><br><span class="ttdesc">此选项仅应在非常特定的情况下使用。正常情况下用户无需使用此选项！</span>`,
        ovx: "水平偏移屏幕截图中显示的通知",
        ovy: "垂直偏移屏幕截图中显示的通知",
        ...
        webhookmain: `切换是否在解锁 $main 成就时向 Discord 服务器发布成就信息`,
        webhooksemi: `切换是否在解锁 $semi 成就时向 Discord 服务器发布成就信息`,
        webhookrare: "切换是否在解锁 $rare 成就时向 Discord 服务器发布成就信息",
        webhookplat: "切换是否在解锁 $plat 成就时向 Discord 服务器发布成就信息",
        ...
        webhookappid: "在 webhook 嵌入的页脚显示当前游戏的 AppID",
        ...
        percentbadgeimgbronze: "当解锁百分比 > $semirarity 时显示的徽章图标",
        sspercentbadgeimgbronze: "当解锁百分比 > $semirarity 时显示的徽章图标",
        percentbadgeimgsilver: "当解锁百分比 < $semirarity 且 > $rarity 时显示的徽章图标",
        sspercentbadgeimgsilver: "当解锁百分比 < $semirarity 且 > $rarity 时显示的徽章图标",
        percentbadgeimggold: "当解锁百分比 < $rarity 时显示的徽章图标",
        sspercentbadgeimggold: "当解锁百分比 < $rarity 时显示的徽章图标",
        percentbadgeimgplat: "当所有成就都已解锁时显示的徽章图标",
        sspercentbadgeimgplat: "当所有成就都已解锁时显示的徽章图标",
        ...
        iconborderimgbronze: "当解锁百分比 > $semirarity 时显示的图标边框图片",
        iconborderimgsilver: "当解锁百分比 < $semirarity 且 > $rarity 时显示的图标边框图片",
        ...
        webhookembedcolormain: "设置在解锁 $main 成就时 webhook 嵌入使用的颜色",
        webhookembedcolorsemi: "设置在解锁 $semi 成就时 webhook 嵌入使用的颜色",
        ...
        lognum: `在删除前保存的以前日志文件数量。每次启动应用程序时都会生成新的日志文件<br><br><span class="ttdesc">当设置为 0 时，退出时所有以前的日志文件将被删除</span>`, 
        detectedappid: `使用当前检测到的游戏的 <span class="hl">AppID</span>`,
    ...
    exclusions: {
        content: {
            ...
            exclusionedit: "编辑排除项",
            exclusioneditsub: [
                `编辑<span class="hl">排除列表</span>中现有的<span class="hl">AppID</span>`
            ]
        }
    },
    inclusions: {
        content: {
            managesub: [
                `将任意 Steam 游戏的 <span class="hl">AppID</span> 添加到 <span class="hl">包含列表</span> 中`,
                `Steam Achievement Notifier 只会尝试跟踪已将 <span class="hl">AppID</span> 添加到 <span class="hl">包含列表</span> 的游戏的成就数据`,
                `<span class="hl help" id="appidhelp"><u>如何找到 Steam 游戏的 AppID？</u></span>`
            ],
            inclusionnew: "新的包含项",
            inclusionnewsub: [
                `输入要添加到 <span class="hl">包含列表</span> 的 <span class="hl">AppID</span>`
            ],
            inclusionedit: "编辑包含项",
            inclusioneditsub: [
                `编辑 <span class="hl">包含列表</span> 中现有的 <span class="hl">AppID</span>`
            ]
        }
    },
    notificationelems: {
