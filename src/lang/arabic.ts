export const translations = {
    ...
    customiser: {
        ...
        style: {
            ...
            content: {
                ...
                bgimg: "صورة الخلفية",
                bgachicon: "استخدم أيقونة الإنجاز",
    ...
    tooltips: {
        ...
        releasedelay: `حدد المدة التي ينتظرها عامل الخلفية قبل إعادة التشغيل بعد تحرير اللعبة الحالية. يؤثر ذلك على كلٍ من تتبع العمليات التلقائي والتحرير التلقائي للألعاب<br><br><span class="ttdesc">يسمح بإطار زمني أطول لتحرير Steamworks بالكامل من التطبيق. قد يؤدي زيادة هذه القيمة إلى منع سلوكيات غير معتادة، مثل تتبع لعبة تم إغلاقها مسبقًا</span>`,
        maxretries: `حدد الحد الأقصى لعدد محاولات إعادة الربط لربط عملية قيد التشغيل بـ AppID تم اكتشافه. يؤثر ذلك على كلٍ من تتبع العمليات التلقائي والتحرير التلقائي للألعاب<br><br><span class="ttdesc">تتم المحاولات مرة واحدة كل ثانية. إذا لم يتم ربط عملية قيد التشغيل بـ AppID الحالي بعد هذا العدد من المحاولات، فسيتم إرجاع عملية غير صالحة. في هذه الحالات، يجب تحرير اللعبة يدويًا عبر System Tray > الخيارات > تحرير اللعبة</span>`,
        ...
        bgachicon: "استخدم أيقونة الإنجاز المفتوح كخلفية للإشعار",
        ...
        copycustompos: "تطبيق الموضع المخصص على جميع أنواع الإشعارات الأخرى",
        ...
        ssmode: `حدد ما إذا كان سيتم التقاط الشاشة بالكامل أو نافذة اللعبة الحالية<span style="color: red;">*</span> في لقطات الشاشة<br><br><span class="ttdesc">إذا تعذر تحديد موقع <span class="hl">ملف التشغيل</span> الخاص باللعبة الحالية (<i>سواء عبر <span class="hl">تتبع العمليات التلقائي</span> أو عند إضافتها كإدخال ضمن <span class="hl">التحرير التلقائي للألعاب</span></i>)، فسيتم تعيين هذا الخيار افتراضيًا على وضع "الشاشة"</span>`,
        ...
        ssaddtosteam: "إضافة الوسائط المُنشأة تلقائيًا إلى التسجيلات ولقطات الشاشة الخاصة باللعبة الحالية في Steam"
    },
    update: {
